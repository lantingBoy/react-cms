    ...
    return (
      menusData
        ...
        .filter(item => {
          ...
          if (pt == '/product/list' || pt == '/product/create') {
            return (
              item.name &&
              !item.hideInMenu &&
              (item.name == 'product' || item.name == 'list' || item.name == 'create')
            );
          }
          if (pt == '/dashboard/workplace' || pt == '/dashboard/analysis') {
            return (
              item.name &&
              !item.hideInMenu &&
              (item.name == 'dashboard' || item.name == 'workplace' || item.name == 'analysis')
            );
          }
          if (pt == '/data/all' || pt == '/data/single' || pt == '/data/channel') {
            return (
              item.name &&
              !item.hideInMenu &&
              (item.name == 'data' ||
          ...
          if (
            pt == '/finance' ||
            pt == '/finance/order' ||
            pt == '/finance/weekorder' ||
            pt == '/finance/cash' ||
            pt == '/finance/cashrecord'
          ) {
            return (
              item.name &&
              !item.hideInMenu &&
