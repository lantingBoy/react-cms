export default {
  ...
  'menu.home': '首页',
  'menu.product': '产品中心',
  'menu.product.list': '产品中心',
  'menu.product.create': '接入管理',
  'menu.timeAxis': '时间轴',
  ...
  'menu.data': '数据中心',
  'menu.data.all': '全部产品',
  'menu.data.single': '单个产品',
  'menu.data.channel': '渠道数据',
  'menu.finance': '财务中心',
  'menu.finance.order': '收益订单',
  'menu.finance.weekorder': '周收益账单',
  'menu.finance.cash': '收益提现',
  'menu.finance.cashrecord': '提现记录',
