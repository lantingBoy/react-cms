...
import findRoute, {
  getUrlQuery,
} from '/Users/test/Documents/workspace/blog/blog-react-admin/node_modules/_umi-build-dev@1.16.7@umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    // Umi UI Bubble
    require('../../../node_modules/_umi-plugin-ui@1.4.7@umi-plugin-ui/lib/bubble').default(
      {
        port: 3001,
        path: '/Users/test/Documents/workspace/blog/blog-react-admin',
        currentProject: '',
        isBigfish: undefined,
      },
    );
...
(() => {
  ...
  window.GUmiUIFlag = require('../../../node_modules/_umi-build-dev@1.16.7@umi-build-dev/lib/plugins/commands/block/sdk/flagBabelPlugin/GUmiUIFlag.js').default;
